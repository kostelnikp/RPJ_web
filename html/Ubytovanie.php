...
<div class="ubytovanie">
    ...
    <form method="post" action="../backend/login.php">
        <div class="ziak">
            ...
            <input id="meno" type="text" name="meno"><br><br>
            <label for="heslo">Heslo: </label>
            <input id="heslo" type="password" name="heslo"><br><br>
            <input id="button" type="submit" value="Prihlásiť sa"><br><br>

            <a href="UbytovanieReg.php">Požiadať o ubytovanie</a><br><br>
        </div>
    </form>
</div>
